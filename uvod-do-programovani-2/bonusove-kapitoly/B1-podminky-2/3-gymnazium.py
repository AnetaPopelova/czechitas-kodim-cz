# Modifikujme si předchozí příklad.
# Horší známku z matematiky může student kompenzovat tím, že uspěje v matematické olympiádě.
# Přidejte tedy dotaz, zda se uchazeč zúčastnil okresního kola matematické olympiády.
# Pokud ano, bude mu zkouška odpuštěna, i kdyby jeho známka z matematiky byla horší.
